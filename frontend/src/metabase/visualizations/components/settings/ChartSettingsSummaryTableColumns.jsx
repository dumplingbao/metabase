...
const unusedSourceItem: DraggableItem = createSectionItem(t`未使用字段`);
    ...
    return (
      <div>
        <div style={{ fontSize: "1rem" }}>
          <h2 className="text-bold text-paragraph mb2">{t`显示设置`}</h2>
        </div>
    ...
    <div className={cx("my2 bordered shadowed  cursor-pointer bg-white")}>
      ...
      <div className="py1 px2 border-grey-1">
        <div className="flex align-center justify-between flex-no-shrink">
          <div className={cx(styles.DescriptionText)}>{t`是否显示总计`}</div>
          <Toggle
            value={columnMetadata.showTotals === false}
            onChange={() =>
              onChange({
                ...columnMetadata,
        ...
        <div className="my1 flex align-center justify-between flex-no-shrink">
          <div className={cx(styles.DescriptionText)}>{t`排序`}</div>
          <div>
            <div
